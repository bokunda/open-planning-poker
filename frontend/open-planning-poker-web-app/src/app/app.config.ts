import { ApplicationConfig, inject, provideZoneChangeDetection, APP_INITIALIZER, isDevMode } from '@angular/core';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideApollo(() => {
      ...
      const gqlGateway = isDevMode()
        ? 'http://localhost:10010/graphql'
        : 'https://gateway.openplanningpoker.com/graphql';
      const gqlGatewayWss = isDevMode()
        ? 'ws://localhost:10010/graphql'
        : 'wss://ge.openplanningpoker.com/graphql';
